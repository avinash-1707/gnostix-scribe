...
export function HeroGeometric({
  badge = "Gnostix Scribe",
  title1 = "MDX tutorials,",
  title2 = "agent-authored.",
  description = "Type a topic. Watch a LangGraph agent scrape, reason, illustrate, and ship a publication-ready MDX file — all live, all yours.",
  children,
}: HeroGeometricProps) {
